...
time.sleep(5)
answer = input("\033[1;32;40m Press 1 if you want to video or Press 2 if you want to upload multiple videos: ")
...
if(int(answer) == 1):
    ...
    for i in range(int(howmany)):
        # bot = webdriver.Chrome(executable_path="C:\\Users\\dell\\Downloads\\youtube-autoupload-bot-master\\youtube-autoupload-bot-master\\chromedriver.exe", chrome_options=options)
        ...
        simp_path = 'Generated Videos/Love/{}'.format(str(nameofvid))
    ...
    for i in range(count):
        ...
        simp_path = 'Generated Videos/vid{}.mp4'.format(str(i+1))
